...
namespace Tests
{
    ...
    public class PrimTests
    {
        ...
        {
            var result = Prim.Run(File.ReadLines("c:\\temp\\homework2_1_2_test.txt"));
        ...
        public void TestCase2ShouldPass()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                var result = Prim.Run(File.ReadLines("c:\\temp\\homework2_1_2_test2.txt"));
                results.Add(result);
            }
        ...
        public void TestCase3ShouldPass()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                var result = Prim.Run(File.ReadLines("c:\\temp\\tinyEWG.txt"));
